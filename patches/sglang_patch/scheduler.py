...
class Scheduler(SchedulerOutputProcessorMixin):
    ...
    def release_memory_occupation(self, recv_req: ReleaseMemoryOccupationReqInput):
        ...
        ######### for support amd release memory
        while not self.flush_cache():
            import time
            time.sleep(0.1)
        from sglang.srt.torch_memory_saver_adapter import _TorchMemorySaverAdapterNoop
        if not isinstance(self.memory_saver_adapter, _TorchMemorySaverAdapterNoop):
