...
# NOTE: use CUDA_VISIBLE_DEVICES instead of ROCR_VISIBLE_DEVICES, because ROCR_VISIBLE_DEVICES has bugs in torch
...
class AMDGPUAcceleratorManager(AcceleratorManager):
    ...
    def set_current_process_visible_accelerator_ids(
        ...
        # NOTE: can not set a empty string to CUDA_VISIBLE_DEVICES, or it will cause error in verl,
        # in fact, it should be a verl bug, but workaround it here is easier
