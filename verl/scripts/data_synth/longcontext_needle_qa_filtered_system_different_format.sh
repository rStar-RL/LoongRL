    ...
    for dataset in "${datasets[@]}"; do
        for seq_len in "${seq_lens[@]}"; do
            ...
            while [ $start_index -lt $total_samples ]; do
                ...
                input_file="${dataset}_qwen_filtered-num_sample_${total_samples}-max_seq_$seq_len-uuid_len_default_8-numchain_$num_chain-numhop-4-distractor.jsonl"
                ...
                python examples/data_preprocess/longcontextqa_needle_like_dataset_system.py \
                    ...
                    --local_dir /mnt/longcontext/models/siyuan/rl_datasets/rl_three/system/${dataset}_filtered-uuid_default_8-numchain_${num_chain}-numhop-4-distractor_${distractor_num}_start_idx${start_index}_end_idx${end_index}_seq${seq_len} \
