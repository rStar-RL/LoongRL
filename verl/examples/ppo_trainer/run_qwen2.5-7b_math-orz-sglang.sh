...
PYTORCH_HIP_ALLOC_CONF=expandable_segments:True RAY_EXPERIMENTAL_NOSET_ROCR_VISIBLE_DEVICES=0 NCCL_TIMEOUT=1800 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='Qwen2.5-7B-math-PPO-orz-align-template-sglang' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=10 \
    trainer.test_freq=5 \
    trainer.default_local_dir=/scratch/nishang/verl_checkpoint/verl-orz/Qwen2.5-7B-math-PPO-orz-align-template-sglang \
    trainer.remove_previous_ckpt_in_save=True \
    trainer.total_epochs=20 $@ 2>&1 | tee Qwen2.5-7B-math-PPO-orz-align-template-sglang.log
