...
PYTORCH_HIP_ALLOC_CONF=expandable_segments:True RAY_EXPERIMENTAL_NOSET_ROCR_VISIBLE_DEVICES=0 NCCL_TIMEOUT=1800 python3 -m verl.trainer.main_ppo \
    ...
    critic.model.path=/scratch/nishang/Qwen2.5-32B-Instruct \
    ...
    trainer.project_name='verl-orz-math-code-sglang' \
    trainer.experiment_name='Qwen2.5-32B-Instruct-math-code-PPO-orz-align-template-sglang-clip' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=4 \
    trainer.save_freq=10 \
    trainer.test_freq=-1 \
    trainer.default_local_dir=/scratch/nishang/verl_checkpoint/verl-orz-math-code/Qwen2.5-32B-Instruct-math-code-PPO-orz-align-template-sglang-clip \
    trainer.remove_previous_ckpt_in_save=True \
    trainer.total_epochs=20 $@ 2>&1 | tee Qwen2.5-32B-Instruct-math-code-PPO-orz-align-template-sglang-clip.log
